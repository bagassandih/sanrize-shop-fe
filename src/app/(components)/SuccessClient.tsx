...
const SuccessClient = () => {
  ...
  if (!selectedGame || !selectedPackage) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-4">
            <PartyPopper className="h-16 w-16 sm:h-20 sm:w-20 text-green-500 mb-6" />
            <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">Purchase Successful!</h1>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-4">
        <PartyPopper className="h-16 w-16 sm:h-20 sm:w-20 text-green-500 mb-6 animate-bounce" />
        <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-3">Thank You! Purchase Complete!</h1>
        ...
        <Card className="w-full max-w-md shadow-xl mb-8 bg-card">
            <CardHeader>
                <CardTitle className="text-xl sm:text-2xl text-primary flex items-center justify-center">
                    <CheckCircle className="mr-2 h-6 w-6 sm:h-7 sm:w-7"/> Order Summary
                </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-left text-sm sm:text-base">
                ...
                <div className="flex justify-between border-t border-border pt-3 mt-3">
                    <span className="text-muted-foreground text-base sm:text-lg">Total Paid:</span>
                    <span className="font-bold text-accent text-base sm:text-lg">${selectedPackage.price.toFixed(2)}</span>
                </div>
            </CardContent>
        </Card>
